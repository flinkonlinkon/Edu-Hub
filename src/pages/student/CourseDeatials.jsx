...
const CourseDeatials = () => {
    ...
    const {allCourses,ratingCalculator,calculateNoOfLectures,calculateCourseDuration,calculateChapterTime,currency} = useContext(AppContext)
    ...
    return courseData ? (
        ...
        <div className='flex  md:flex-row flex-col-reverse gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left'>
                                    ...
                                    <div className='pt-5'>
                                        {
                                            courseData.courseContent.map((chapter,index)=>(
                                                ...
                                                <div key={index} className='border border-gray-300 bg-white mb-2 rounded'>
                                                    ...
                                                    <ul className='list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-green-300'>
           ...
           <div className='max-w-course-card z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[450px]'>
            {
                            playerData ?
                ...
                <div className='p-5'>
                    ...
                    <button className='md:mt-6 mt-4 w-full py-3 rounded bg-blue-600 text-white font-medium'>
                        {isAlreadyEnroll ? 'Already Enrolled' : 'Enroll Now'}
                    </button>
                    ...
                    <div className='pt-6'>
                        ...
                        <ul className='ml-4 pt-2 text-sm md:text-default list-disc text-gray-500'>
                            ...
                            <li>Quizz to test your knowledge</li>
