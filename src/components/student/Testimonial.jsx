...
const Testimonial = () => {
    return (
        <div className='pb-14 px-8 md:px-0'>
            ...
            <p className='text-gray-500 mt-3 md:text-base'>Hear from our learners as they share their journeys of transformation, success, and how our <br></br> platform has made a difference in their lives.</p>
        ...
        <div className='grid grid-cols-auto gap-8 mt-14'>
            {dummyTestimonial.map((testimonial,index)=>(
                <div key={index} className='text-sm text-left border border-gray-500/30 pb-6 rounded-lg bg-white shadow-[0px_4px_15px_0px] shadow-black/5 overflow-hidden'>
                    <div className='flex items-center gap-4 px-5 py-3 bg-gray-500/10'>
